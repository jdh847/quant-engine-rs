...
- Intuitive dashboard UI (`dashboard.html`) plus share/export pages (`dashboard_share.html`, `dashboard_cover.html`) and theme variants for GitHub/X/Xiaohongshu
...
- Strategy comparison market + plugin + command filters (`ALL` / per-market using registry `markets`, per-plugin drill-down, and command-type isolation)
...
- `outputs_rust/dashboard_cover_github.html`
- `outputs_rust/dashboard_cover_x.html`
- `outputs_rust/dashboard_cover_xiaohongshu.html`
